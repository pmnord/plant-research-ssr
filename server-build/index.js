...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony default export */ __webpack_exports__[\"default\"] = ({\n  API_ENDPOINT: process.env.REACT_APP_ENVIRONMENT === 'development' ? 'http://localhost:8000/api' : process.env.REACT_APP_FANCYPLANTS_SERVER,\n  API_KEY: process.env.REACT_APP_FANCYPLANTS_API_KEY,\n  TREFLE_API_KEY: process.env.TREFLE_API_KEY,\n  TOKEN_KEY: `Authorization`\n});\n\n//# sourceURL=webpack:///./src/config.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _config__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../config */ \"./src/config.js\");\n // import window from 'global';\n\nconst TokenService = {\n  setToken(token) {// return window.localStorage.setItem(`${config.TOKEN_KEY}`, token);\n  },\n\n  getToken() {// return window.localStorage.getItem(config.TOKEN_KEY);\n  },\n\n  clearToken() {// return window.localStorage.removeItem(config.TOKEN_KEY);\n  },\n\n  hasToken() {\n    return !!TokenService.getToken();\n  }\n\n};\n/* harmony default export */ __webpack_exports__[\"default\"] = (TokenService);\n\n//# sourceURL=webpack:///./src/services/tokenService.js?");
